...
class StudentManagementApp(QMainWindow):
    ...
    def initAddTab(self):
        ...
        self.add_total_score_label = QtWidgets.QLabel("Total Score (must be greater than 0 and less than 4):")
    ...
    def add_student(self):
        ...
        try:
            ...
            if total_score <= 0 or total_score >= 4:
                QMessageBox.critical(self, "Error", "Total score must be greater than 0 and less than 4.")  # Ensure total score is within the range
                return
        except ValueError:
    ...
    def initEditTab(self):
        ...
        self.edit_total_score_label = QtWidgets.QLabel("Total Score (must be greater than 0 and less than 4):")
